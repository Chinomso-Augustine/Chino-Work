import { Star, User, Clock, Search } from "lucide-react";
    ...
    return (
        <div className="bg-purple-50/40 text-slate-900">
            ...
            <section className="bg-white py-10 flex flex-wrap items-center md:flex-row sm:flex-row justify-center gap-3 border-y border-purple-200/60">
                {stats.map((stat, index) => (
                    ...
                    >
                        ...
                        <div className="text-sm mt-2 text-purple-500">
                            {stat.label}
                        </div>
            ...
            <section className="bg-white py-16 px-6 border-t border-purple-200/60" >
                ...
                <p className="text-base text-center text-slate-600 mb-12 max-w-2xl mx-auto">We make it easy to find trusted services from fellow students on your campus.</p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 max-w-6xl mx-auto">
                    ...
                    {reason.map((whyUs, index) => (
                        <div
                            ...
                            <div className="bg-purple-700 w-12 h-12 text-white text-center rounded-xl flex items-center justify-center">{whyUs.icon}</div>
            ...
            <footer className="bg-purple-900 py-12">
                ...
                <p className="text-slate-300 text-base font-medium flex text-center justify-center m-4 ">Join our community of students helping students. Find the services you need or offer your skills to others.</p>
