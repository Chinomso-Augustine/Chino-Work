...
function Page() {
    ...
    return (
        <div>
            <section className="relative bg-gradient-to-br from-purple-700 via-indigo-800 to-purple-700 text-white h-[20vh] py-100 px-6 flex-col items-center justify-center ">
                <div
