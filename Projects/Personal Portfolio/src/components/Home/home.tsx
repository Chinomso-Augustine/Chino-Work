...
function Home() {
    ...
    const skills = [
        { value: "HTML", icon: SiHtml5 },
        { value: "CSS", icon: SiCss3 },
        { value: "JavaScript", icon: SiJavascript },
        { value: "React", icon: FaReact },
        { value: "C", icon: SiC },
        { value: "C++", icon: SiCplusplus },
        { value: "Lightroom", icon: SiAdobelightroom },
        { value: "Illustrator", icon: SiAdobeillustrator },
            ...
            <section className="bg-gradient-to-b from-purple-200 to-white py-16 flex flex-col justify-center items-center overflow-auto ">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 max-w-6xl mx-auto">
                    {aboutMe.map((events, index) => (
                        ...
                        >
                            <h3 className="font-semibold text-purple-900 text-lg text-center my-2">
                                {events.value}
                            </h3>
                            <img
                                src={events.img}
